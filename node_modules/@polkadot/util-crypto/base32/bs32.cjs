...
const BASE32_CONFIG = {
  ...
  _microBase.utils.radix2(5), _microBase.utils.alphabet(BASE32_ALPHABET), {
...
const base32Validate = (0, _helpers.createValidate)(BASE32_CONFIG);
/**
* @name isBase32
...
const base32Decode = (0, _helpers.createDecode)(BASE32_CONFIG, base32Validate);
/**
* @name base32Encode
...
const base32Encode = (0, _helpers.createEncode)(BASE32_CONFIG);

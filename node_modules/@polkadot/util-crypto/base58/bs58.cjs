...
const base58Validate = (0, _helpers.createValidate)(BASE58_CONFIG);
/**
 * @name base58Decode
...
const base58Decode = (0, _helpers.createDecode)(BASE58_CONFIG, base58Validate);
/**
* @name base58Encode
...
const base58Encode = (0, _helpers.createEncode)(BASE58_CONFIG);
/**
* @name isBase58
